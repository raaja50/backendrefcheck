...
<head>
    ...
    <title>Reference Check 360°</title>
                            ...
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header border-0">
                                    <div class="card-title text-center">
                                        <div class="p-1"><img src="app-assets/images/logo/log-.png" alt="branding logo"></div>
                                    </div>
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-body pt-0">
                                        <form class="form-horizontal"  method="post" action="login_register/login.php">
                                            ...
                                            <button type="submit" class="btn btn-outline-primary btn-block" name="login_user"><i class="feather icon-unlock"></i> Login</button>
                                        </form>
                                    </div>
