                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <div class="dropdown-divider"></div><a class="dropdown-item" href="login-with-bg.php"><i class="feather icon-power"></i> Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="main-menu-content ps ps--active-y">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item"><a href="my-cart.php"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">Cart</span></a></li>
                    ...
                    <li><a class="menu-item" href="products.php" data-i18n="CRM">Products</a>
                        </li>
                    <li><a class="menu-item" href="my-cart.php" data-i18n="CRM">Cart</a> </li>
                        
                    </ul> -->
                
                <!-- <li class="nav-item has-sub"><a href="#"><i class="feather icon-monitor"></i><span class="menu-title" data-i18n="Templates">Templates</span></a>
                    <ul class="menu-content">
                        <li class="has-sub"><a class="menu-item" href="#" data-i18n="Vertical">Vertical</a>
                            <ul class="menu-content">
                        ...
                        <li class="has-sub"><a class="menu-item" href="#" data-i18n="Horizontal">Horizontal</a>
                            <ul class="menu-content">
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-layout"></i><span class="menu-title" data-i18n="Layouts">Layouts</span></a>
                    <ul class="menu-content">
                        <li class="has-sub"><a class="menu-item" href="#" data-i18n="Page Layouts">Page Layouts</a>
                            <ul class="menu-content">
                                ...
                                <li class="has-sub"><a class="menu-item" href="#" data-i18n="Sidebar">Sidebar</a>
                                    <ul class="menu-content">
                        ...
                        <li class="has-sub"><a class="menu-item" href="#" data-i18n="Navbars">Navbars</a>
                            <ul class="menu-content">
                                ...
                                <li class="has-sub"><a class="menu-item" href="#" data-i18n="Hide on Scroll">Hide on Scroll</a>
                                    <ul class="menu-content">
                        ...
                        <li class="has-sub"><a class="menu-item" href="#" data-i18n="Vertical Nav">Vertical Nav</a>
                            <ul class="menu-content">
                                <li class="has-sub"><a class="menu-item" href="#" data-i18n="Navigation Types">Navigation Types</a>
                                    <ul class="menu-content">
                        ...
                        <li class="has-sub"><a class="menu-item" href="#" data-i18n="Horizontal Nav">Horizontal Nav</a>
                            <ul class="menu-content">
                                <li class="has-sub"><a class="menu-item" href="#" data-i18n="Navigation Types">Navigation Types</a>
                                    <ul class="menu-content">
                                        <li><a class="menu-item" href="../horizontal-menu-template" data-i18n="Classic">Classic</a>
                        ...
                        <li class="has-sub"><a class="menu-item" href="#" data-i18n="Dashboard">Page Headers</a>
                            <ul class="menu-content">
                        ...
                        <li class="has-sub"><a class="menu-item" href="#" data-i18n="Footers">Footers</a>
                            <ul class="menu-content">
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-zap"></i><span class="menu-title" data-i18n="Starter kit">Starter kit</span><span class="badge badge badge-danger badge-pill float-right mr-2">New</span></a>
                    <ul class="menu-content">
                        ...
                        <li class="has-sub"><a class="menu-item" href="#" data-i18n="Content Detached Sidebar">Content Detached Sidebar</a>
                            <ul class="menu-content">
                ...
                <!-- <l`i class=" nav-item"><a href="app-chat.html"><i class="feather icon-message-square"></i><span class="menu-title" data-i18n="Chat Application">Chat Application</span></a>
                </li>` -->
                ...
                <!-- <li class="nav-item has-sub"><a href="#"><i class="feather icon-plus-square"></i><span class="menu-title" data-i18n="Calender">Calender</span></a>
                    <ul class="menu-content">
                ...
                <!-- <li class="nav-item has-sub"><a href="#"><i class="feather icon-file-text"></i><span class="menu-title" data-i18n="Invoice">Invoice</span></a>
                    <ul class="menu-content">
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-share"></i><span class="menu-title" data-i18n="Timelines">Timelines</span></a>
                    <ul class="menu-content">
                ...
                <li class="nav-item has-sub open"><a href="#"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Users">Users</span></a>
                    <ul class="menu-content">
                        <li class="active"><a class="menu-item" href="page-users-list.html" data-i18n="Users List">Users List</a>
                        </li>
                        <li class=""><a class="menu-item" href="page-users-view.html" data-i18n="Users View">Users View</a>
                        </li>
                        <li class=""><a class="menu-item" href="page-users-edit.html" data-i18n="Users Edit">Users Edit</a>
                        </li>
                        <li class=""><a class="menu-item" href="user-profile.html" data-i18n="Users Profile">Users Profile</a>
                        </li>
                        <li class=""><a class="menu-item" href="user-cards.html" data-i18n="Users Cards">Users Cards</a>
                        </li>
                    </ul>
                </li> -->
                <!-- <li class="nav-item has-sub"><a href="#"><i class="feather icon-image"></i><span class="menu-title" data-i18n="Gallery">Gallery</span></a>
                    <ul class="menu-content">
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-search"></i><span class="menu-title" data-i18n="Search">Search</span></a>
                    <ul class="menu-content">
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-unlock"></i><span class="menu-title" data-i18n="Authentication">Authentication</span></a>
                    <ul class="menu-content">
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-alert-triangle"></i><span class="menu-title" data-i18n="Error">Error</span></a>
                    <ul class="menu-content">
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-watch"></i><span class="menu-title" data-i18n="Coming Soon">Coming Soon</span></a>
                    <ul class="menu-content">
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-globe"></i><span class="menu-title" data-i18n="Content">Content</span></a>
                    <ul class="menu-content">
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-square"></i><span class="menu-title" data-i18n="Cards">Cards</span><span class="badge badge badge-pill badge-success float-right mr-2">Hot</span></a>
                    <ul class="menu-content">
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-layers"></i><span class="menu-title" data-i18n="Advance Cards">Advance Cards</span></a>
                    <ul class="menu-content">
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-droplet"></i><span class="menu-title" data-i18n="Color Palette">Color Palette</span><span class="badge badge badge-warning badge-pill float-right mr-2">14</span></a>
                    <ul class="menu-content">
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-eye"></i><span class="menu-title" data-i18n="Icons">Icons</span></a>
                    <ul class="menu-content">
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-briefcase"></i><span class="menu-title" data-i18n="Bootstrap Components">Bootstrap Components</span></a>
                    <ul class="menu-content">
                        ...
                        <li class="has-sub"><a class="menu-item" href="#" data-i18n="Buttons">Buttons</a>
                            <ul class="menu-content">
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-box"></i><span class="menu-title" data-i18n="Extra Components">Extra Components</span></a>
                    <ul class="menu-content">
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-edit"></i><span class="menu-title" data-i18n="Forms">Forms</span></a>
                    <ul class="menu-content">
                        <li class="has-sub"><a class="menu-item" href="#" data-i18n="Form Elements">Form Elements</a>
                            <ul class="menu-content">
                        ...
                        <li class="has-sub"><a class="menu-item" href="#" data-i18n="Form Layouts">Form Layouts</a>
                            <ul class="menu-content">
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-grid"></i><span class="menu-title" data-i18n="Tables">Tables</span></a>
                    <ul class="menu-content">
                        <li class="has-sub"><a class="menu-item" href="#" data-i18n="Bootstrap Tables">Bootstrap Tables</a>
                            <ul class="menu-content">
                        ...
                        <li class="has-sub"><a class="menu-item" href="#" data-i18n="DataTables">DataTables</a>
                            <ul class="menu-content">
                                ...
                                <li class="has-sub"><a class="menu-item" href="#" data-i18n="DataTables Ext">DataTables Ext</a>
                                    <ul class="menu-content">
                                        ...
                                        <li class="has-sub"><a class="menu-item" href="#" data-i18n="Buttons">Buttons</a>
                                            <ul class="menu-content">
                                                ...
                                                <li><a class="menu-item" href="dt-extensions-buttons-html-5-data-export.html" data-i18n="HTML 5 Data Export">HTML 5 Data Export1</a>
                                                </li>
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-bar-chart-2"></i><span class="menu-title" data-i18n="Charts">Charts</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="charts-apexcharts.html" data-i18n="Apex Charts">Apex Charts</a>
                        </li>
                        <li class="has-sub"><a class="menu-item" href="#" data-i18n="Chartjs">Chartjs</a>
                            <ul class="menu-content">
                        ...
                        <li class="has-sub"><a class="menu-item" href="#" data-i18n="Chartist">Chartist</a>
                            <ul class="menu-content">
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-map"></i><span class="menu-title" data-i18n="Maps">Maps</span></a>
                    <ul class="menu-content">
                ...
                <li class="nav-item has-sub"><a href="#"><i class="feather icon-align-left"></i><span class="menu-title" data-i18n="Menu levels">Menu levels</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="#" data-i18n="Second level">Second level</a>
                        </li>
                        <li class="has-sub"><a class="menu-item" href="#" data-i18n="Second level child">Second level child</a>
                            <ul class="menu-content">
                                <li><a class="menu-item" href="#" data-i18n="Third level">Third level</a>
                                </li>
                                <li class="has-sub"><a class="menu-item" href="#" data-i18n="Third level child">Third level child</a>
                                    <ul class="menu-content">
