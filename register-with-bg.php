            ...
            <div class="content-body">
                <section class="row flexbox-container">
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0 main-card-form">
                            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                <div class="card-header border-0 pb-0">
                                    <div class="card-title text-center">
                                        <img src="app-assets/images/logo/log-.png" alt="branding logo">
                                    </div>
                                    ...
                                    <div class="card-body pt-0">
                                        <form class="form-horizontal" action="index.html">
                                            <fieldset class="form-group floating-label-form-group">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <h3 class="cra-hd"> Current Residential Address </h3>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control" id="pob1">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <h3 class="cra-hd"> Security Question </h3> <br>
                                                    </div>
                                                </div>
